...
async function VerifyPayment(req, res) {
  try {
    ...
    await db.collection("payments").insertOne({ booking_id: new ObjectId(booking_id), user_id: new ObjectId(req.user._id), amount: booking.total_amount, payment_type: "Razorpay", razorpay_order_id, razorpay_payment_id, razorpay_signature, status: "Success", date: new Date() });
